...
def main(page: ft.Page):
    ...
    # Caja de texto para mostrar el precio cargado
    precio_cargado = ft.TextField(label="Precio de la Factura Cargada")
    ...
    def modificar_factura(e):
        try:
            ...
            if 0 <= index < len(facturas):
                ...
                output.value = f"Factura modificada en el índice {index}:\n{str(factura)}"
            else:
    ...
    def cargar_factura(e):
        try:
            ...
            if 0 <= index < len(facturas):
                ...
                # Mostrar el precio en la caja de texto adicional
    ...
    page.add(
        *inputs.values(),
        precio_cargado,  # Agregar la caja de texto para el precio
        btn_agregar,
